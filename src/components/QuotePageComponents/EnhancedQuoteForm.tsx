    ...
    <div ref={ref} className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
      ...
      <div className="bg-gradient-to-r from-amber-50 to-orange-50 px-8 py-6 border-b border-gray-100">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-2xl font-bold text-gray-900">Formularz wyceny</h2>
          ...
          {stepTitles.map((title, index) => (
            <div key={index} className="flex items-center">
              ...
              {index < stepTitles.length - 1 && (
                <div className={`ml-6 w-16 h-1 rounded transition-colors duration-300 ${
      ...
      <div className="p-8 lg:p-12">
        {step === 1 && (
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-6">Wybierz rodzaj usługi szkoleniowej</h3>
              <Controller
                name="serviceType"
                control={control}
                    ...
                    {[
                      ...
                      <div key={option.value} className="flex items-start space-x-3 p-4 rounded-xl border border-gray-200 hover:border-amber-300 hover:bg-amber-50 transition-all duration-300 group cursor-pointer">
                        ...
                        <div className="flex-1">
                          <Label htmlFor={option.value} className="font-semibold text-gray-900 group-hover:text-amber-700 cursor-pointer">
                            {option.label}
                          </Label>
            ...
            <div className="pt-6 flex justify-end">
              <Button type="submit" size="lg" className="bg-amber-500 hover:bg-amber-600 text-white px-8 py-3 font-semibold group">
                Dalej
        ...
        {step === 2 && (
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            <h3 className="text-xl font-semibold text-gray-900 mb-6">Szczegóły szkolenia</h3>
            ...
            {serviceType && participantsCount && (
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-6">
                ...
                <p className="text-2xl font-bold text-green-700">{getEstimatedPrice()}</p>
            ...
            <div className="pt-6 flex justify-between">
              <Button type="button" variant="outline" size="lg" onClick={goBack} className="px-8 py-3 group">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="pt-6 flex justify-between">
              ...
              <Button 
                ...
                className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white px-10 py-3 font-bold shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300"
              >
                {isSubmitting ? (
