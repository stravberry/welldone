  ...
  const servicesData: Record<string, ServiceDetail> = {
    ...
    'eventy': {
      ...
      content: (
        <div>
          <div className="text-center mb-12">
            <h3 className="text-3xl font-semibold text-gray-800 mb-4">Lista dostępnych rodzajów eventów:</h3>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Wybierz event który Cię interesuje
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">Całodniowe wydarzenie obejmujące szereg aktywności: prelekcje, warsztaty, pokazy, konkursy.</p>
                <div className="grid grid-cols-1 gap-4">
                  <div>
          ...
          <div className="bg-orange-50 py-16 px-4 rounded-xl mb-12">
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg shadow-md flex items-start">
                  <Check className="h-6 w-6 text-green-500 mr-4 mt-1 flex-shrink-0" />
                  <span className="text-lg">Zwiększenie zaangażowania pracowników</span>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-md flex items-start">
                  <Check className="h-6 w-6 text-green-500 mr-4 mt-1 flex-shrink-0" />
                  <span className="text-lg">Budowanie kultury organizacyjnej</span>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-md flex items-start">
                  <Check className="h-6 w-6 text-green-500 mr-4 mt-1 flex-shrink-0" />
                  <span className="text-lg">Praktyczny wymiar szkoleń</span>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-md flex items-start">
                  <Check className="h-6 w-6 text-green-500 mr-4 mt-1 flex-shrink-0" />
                  <span className="text-lg">Zwiększenie bezpieczeństwa pracy</span>
                </div>
              </div>
            </div>
          </div>
