...
interface EventyContactFormProps {
  formData: FormData;
  handleInputChange: (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => void;
  handleSubmit: (e: React.FormEvent) => void;
}

const EventyContactForm: React.FC<EventyContactFormProps> = ({
  formData,
  handleInputChange,
  handleSubmit
}) => {
  ...
  return (
    <section id="contact-form" className="py-12 sm:py-16 lg:py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        >
          <span className="text-purple-600 font-medium text-sm sm:text-base">Kontakt</span>
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mt-2 mb-4">Skontaktuj się z nami</h2>
          <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto">
            Masz pytania o nasze eventy? Wypełnij formularz, a nasz konsultant skontaktuje się z Tobą w ciągu 24 godzin
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <Input 
                ...
                className="mt-1 transition-all duration-300 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 hover:border-purple-300" 
                name="name"
                value={formData.name}
            ...
            <div className="md:col-span-2">
              <Button 
                type="submit"
                className="w-full bg-purple-600 hover:bg-purple-700 py-6 transform transition-all duration-300 hover:scale-105 hover:shadow-xl"
              >
                Wyślij wiadomość
              </Button>
...
export default EventyContactForm;
