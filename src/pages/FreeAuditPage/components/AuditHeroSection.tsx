...
const AuditHeroSection: React.FC<AuditHeroSectionProps> = ({ onCTAClick }) => {
  ...
  return (
    <section className="relative bg-gradient-to-br from-orange-600 via-orange-500 to-amber-500 py-16 lg:py-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10" ref={elementRef}>
        ...
        <div className="text-center mb-8">
          <div 
            className={`inline-block bg-white bg-opacity-25 backdrop-blur-sm px-6 py-3 rounded-full text-white font-semibold transition-all duration-800 shadow-lg ${
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-16">
          ...
          <div className="text-left">
            ...
            <p 
              className={`text-lg md:text-xl text-orange-50 mb-8 leading-relaxed transition-all duration-800 ${
                isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'
              }`}
              style={{ 
            ...
            >
              <Button 
                size="lg" 
                onClick={onCTAClick}
                className="bg-white text-orange-600 hover:bg-orange-50 hover:scale-105 transition-all duration-300 shadow-2xl text-lg px-8 py-6 h-auto font-semibold"
              >
              ...
              <Button 
                size="lg" 
                variant="outline"
                className="border-2 border-white text-white hover:bg-white hover:text-orange-600 hover:scale-105 transition-all duration-300 text-lg px-8 py-6 h-auto bg-white bg-opacity-10 backdrop-blur-sm font-semibold"
              >
          ...
          <div className="hidden lg:flex justify-center items-center">
            <div 
              className={`relative transition-all duration-1000 ${
                isInView ? 'opacity-100 scale-100 rotate-0' : 'opacity-0 scale-75 rotate-12'
              }`}
            ...
            >
              ...
              <ClipboardCheck 
                size={280}
                className="text-white opacity-90 relative z-10 drop-shadow-2xl"
              />
        ...
        {/* Animated stats */}
        <div 
          className={`grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 transition-all duration-1000 ${
            isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}
