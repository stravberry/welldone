  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div ref={heroRef} className="relative bg-gradient-to-br from-yellow-600 via-yellow-500 to-yellow-400 py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        {/* Lightning Bolt Background Icon - positioned far right */}
        <div className={`absolute -right-20 top-0 bottom-0 flex justify-end items-center transition-all duration-800 ${
