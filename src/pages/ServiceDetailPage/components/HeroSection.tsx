...
import { Phone, Mail, Forklift } from 'lucide-react';
...
const HeroSection: React.FC<HeroSectionProps> = ({ 
  ...
  return (
    <div className="relative bg-gradient-to-br from-orange-600 via-orange-500 to-orange-400 py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      {/* Centered Background Forklift Icon */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 hidden lg:block transition-all duration-1000 opacity-100">
        <Forklift 
          size={400}
          className="text-orange-200 opacity-20"
        />
      </div>

      {/* Mobile Background Forklift Icon */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 lg:hidden transition-all duration-1000 opacity-100">
        <Forklift 
          size={200}
          className="text-orange-200 opacity-10"
        />
      </div>
