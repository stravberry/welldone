...
const ContactFormSection: React.FC<ContactFormSectionProps> = ({
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    trackEvent({
      category: 'form',
      action: 'submit',
      label: 'contact-form-udt-operators',
      additionalData: {
        formName: 'contact-form',
        page: 'service-detail-udt-operators'
      }
    });
    handleSubmit(e);
  };
    ...
    <section id="contact-form" className="py-12 sm:py-16 lg:py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mt-2 mb-4">Zapisz się na szkolenie</h2>
